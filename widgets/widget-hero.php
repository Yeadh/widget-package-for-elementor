...
class Hero_widgets extends Widget_Base {
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'infobox_section',
         [
            'label' => esc_html__( 'Infobox', 'hero-for-elementor' ),
      ...
      $this->add_control(
        'text_align',
        [
          'label' => __( 'Alignment', 'hero-for-elementor' ),
          'type' => \Elementor\Controls_Manager::CHOOSE,
          'options' => [
            'left' => [
              'title' => __( 'Left', 'hero-for-elementor' ),
              'icon' => 'fa fa-align-left',
            ],
            'center' => [
              'title' => __( 'Center', 'hero-for-elementor' ),
              'icon' => 'fa fa-align-center',
            ],
            'right' => [
              'title' => __( 'Right', 'hero-for-elementor' ),
      ...
      $this->add_control(
        'icon_style',
        [
          'label' => __( 'Icon style', 'hero-for-elementor' ),
          'type' => \Elementor\Controls_Manager::CHOOSE,
          'options' => [
            'fonticon' => [
              'title' => __( 'Font icon', 'hero-for-elementor' ),
              'icon' => 'fa fa-icons',
            ],
            'imageicon' => [
              'title' => __( 'Image icon', 'hero-for-elementor' ),
              'icon' => 'fa fa-images',
            ]
          ],
          'default' => 'fonticon',
      ...
      $this->add_control(
         'icon',
         [
            'label' => __( 'Icon', 'hero-for-elementor' ),
      ...
      $this->add_control(
         'font_icon',
         [
            'label' => __( 'Font Icon', 'hero-for-elementor' ),
      ...
      $this->add_control(
        'font_color',
        [
          'label' => __( 'Font Color', 'hero-for-elementor' ),
      ...
      $this->add_control(
         ...
         [
            ...
            'default' => __('Awesome Design','hero-for-elementor'),
         ]
      );
      ...
      $this->add_control(
         'text',
         [
            'label' => __( 'Text', 'hero-for-elementor' ),
            'type' => \Elementor\Controls_Manager::TEXTAREA,
            'default' => __('Lorem ipsum dummy text are used here so replace your app data, ipsum dummy text are used here so','hero-for-elementor'),
         ]
      );
      ...
      $this->add_control(
        'text_color',
        [
          'label' => __( 'Text Color', 'hero-for-elementor' ),
          'type' => \Elementor\Controls_Manager::COLOR,
          'scheme' => [
            'type' => \Elementor\Scheme_Color::get_type(),
            'value' => \Elementor\Scheme_Color::COLOR_1,
      ...
      $this->add_control(
        ...
        [
           ...
           'type' => \Elementor\Controls_Manager::TEXT,
           'default' => __('Readmore','hero-for-elementor'),
        ]
      );
